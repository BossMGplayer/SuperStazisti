        ...
        <form action="{{route('jo.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-8 offset-2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') ? old('description') : $user->profile->description }}" required autocomplete="description">
